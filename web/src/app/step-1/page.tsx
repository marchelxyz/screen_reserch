              ...
              <QuestionCard key={spec.key} title={title}>
                <label className="block">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-black/10 bg-white px-3 py-2 text-[15px] text-[#1a1a1a] outline-none ring-[#00B596]/30 focus:border-[#00B596] focus:ring-2"
                    autoComplete="off"
                  />
                </label>
              </QuestionCard>
